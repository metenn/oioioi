...
TEMPLATES = [
    ...
    #     "APP_DIRS": True,
    #     "OPTIONS": {
    #         "environment": "oioioi.base.jinja2.environment",
    #         "context_processors": [
...
PROBLEM_PACKAGE_BACKENDS = ("oioioi.sinolpack.package.SinolPackageBackend",)
...
AVAILABLE_COMPILERS = {
    ...
    "C++": {"g++4_8_2_cpp11": {"display_name": "g++:4.8.2 std=c++11"}},
    "Pascal": {"fpc2_6_2": {"display_name": "fpc:2.6.2"}},
    "Java": {"java1_8": {"display_name": "java:1.8"}},
    "Python": {"python": {"display_name": "python"}},
    "Output-only": {"output-only": {"display_name": "output-only"}},
}

SYSTEM_COMPILERS = {
    "C": {"system-gcc": {"display_name": "system gcc"}},
    "C++": {"system-g++": {"display_name": "system g++"}},
    "Pascal": {"system-fpc": {"display_name": "system fpc"}},
    "Java": {"system-java": {"display_name": "system java"}},
    "Python": {"system-python": {"display_name": "system python"}},
    "Output-only": {"output-only": {"display_name": "output-only"}},
}
...
DEFAULT_TEST_SCORER = "oioioi.programs.utils.discrete_test_scorer"
DEFAULT_GROUP_SCORER = "oioioi.programs.utils.min_group_scorer"
DEFAULT_SCORE_AGGREGATOR = "oioioi.programs.utils.sum_score_aggregator"
...
BROKER_URL = "sqla+sqlite:///" + os.path.join(tempfile.gettempdir(), "celerydb.sqlite")
...
REST_FRAMEWORK["DEFAULT_THROTTLE_RATES"] = {"anon": "1000/day", "user": "1000/hour"}
